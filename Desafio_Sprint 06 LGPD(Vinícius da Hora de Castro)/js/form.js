...
document.addEventListener('click', () => {
    let checkbox = document.getElementById("termos1");
    (checkbox.checked) ? document.querySelector(".enviar_botao").removeAttribute("disabled") : document.querySelector(".enviar_botao").setAttribute("disabled", true);
});